 ...
 */
class StringCol: public BaseColumn {
   public:
    const char** _entries;
    StringCol() : BaseColumn(ColumnType::STRING, DEFAULT_CAPACITY) {
 ...
 */
class IntegerCol : public BaseColumn {
   public:
    int* _entries;
    IntegerCol() : BaseColumn(ColumnType::INTEGER, DEFAULT_CAPACITY) {
        _entries = new int[_capacity];
    }
    virtual ~IntegerCol() { delete[] _entries; }
 ...
 */
class FloatCol : public BaseColumn {
   public:
    float* _entries;
    FloatCol() : BaseColumn(ColumnType::FLOAT, DEFAULT_CAPACITY) {
        _entries = new float[_capacity];
    }
    virtual ~FloatCol() { delete[] _entries; }
 ...
 */
class BoolCol : public BaseColumn {
   public:
    bool* _entries;
    BoolCol() : BaseColumn(ColumnType::BOOL, DEFAULT_CAPACITY) {
        _entries = new bool[_capacity];
    }
    virtual ~BoolCol() { delete[] _entries; }
